...
from initialize import CustomCSVLoader
...
# サイドバー表示系
# ==========================================
SIDEBAR_PURPOSE_TITLE = "利用目的"
SIDEBAR_MODE1_DESCRIPTION = "入力内容と関連性が高い社内文書のありかを検索できます。"
SIDEBAR_MODE2_DESCRIPTION = "質問・要望に対して、社内文書の情報をもとに回答を得られます。"
SIDEBAR_MODE1_EXAMPLE = "【入力例】\n社員の育成方針に関するMTGの議事録"
SIDEBAR_MODE2_EXAMPLE = "【入力例】\n人事部に所属している従業員情報を\n一覧化して"
...
SUPPORTED_EXTENSIONS = {
    ".pdf": PyMuPDFLoader,
    ".docx": Docx2txtLoader,
    ".csv": lambda path: CustomCSVLoader(path, encoding="utf-8"),
    ".txt": TextLoader
}
